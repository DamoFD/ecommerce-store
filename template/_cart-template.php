    ...
    <div class="container">
      <div class="items">
        ...
        <?php
            ...
            echo '<p class="font-roboto font-size-20 color-primary empty-txt">Your shopping cart is empty</p>';
          }
        } else {
          echo '<p class="font-robot font-size-20 color-primary empty-txt">Please log in to view your cart</p>';
        }
        ?>
      </div>
      <!--Subtotal Section-->
