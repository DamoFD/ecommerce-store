...
<section id="blogs">
        <div>
          <h2 class="font-mont font-size-xl color-primary">Latest Blogs</h2>
              ...
              <div class="card">
                ...
                <div class="col">
                  ...
                  <p class="font-size-20 font-roboto color-primary">
                    ...
                    Magnam cum eaque soluta porro amet sapiente illo nemo quis
                    tempora voluptas.
                  </p>
                  <a class="font-roboto font-size-20" href="#">Read More</a>
                </div>
              </div>
            </div>
            <div class="item">
